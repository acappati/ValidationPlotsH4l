...
def runMC(outFile): 
    ...
    if '2018' in outFile:
        samples = [
            # ggZZ from 2018
            dict(name = "ggTo4mu",filename = pathMC2018+"ggTo4mu_Contin_MCFM701/ZZ4lAnalysis.root"),
            dict(name = "ggTo4e",filename = pathMC2018+"ggTo4e_Contin_MCFM701/ZZ4lAnalysis.root"),
            dict(name = "ggTo4tau",filename = pathMC2018+"ggTo4tau_Contin_MCFM701/ZZ4lAnalysis.root"),
            dict(name = "ggTo2e2mu",filename = pathMC2018+"ggTo2e2mu_Contin_MCFM701/ZZ4lAnalysis.root"),       
            dict(name = "ggTo2e2tau",filename = pathMC2018+"ggTo2e2tau_Contin_MCFM701/ZZ4lAnalysis.root"),
            dict(name = "ggTo2mu2tau",filename = pathMC2018+"ggTo2mu2tau_Contin_MCFM701/ZZ4lAnalysis.root"),

            dict(name = "ZH125",filename = pathMC2018+"ZH125/ZZ4lAnalysis.root"),

            dict(name = "VBFToZZTo4l",filename = pathMC2018 + "VBFToContinToZZTo4l/ZZ4lAnalysis.root"),
            dict(name = "TTZToLLNuNu",filename = pathMC2018 + "TTZToLLNuNu_M10ext1/ZZ4lAnalysis.root"),
            dict(name = "TTZJets",filename = pathMC2018 + "TTZJets_M10_MLMext1/ZZ4lAnalysis.root"),
        ]
    elif '2022EE' in outFile:
        samples = [
            dict(name = "ggH125",filename = pathMC2022EE+"ggH125/ZZ4lAnalysis.root"),
            dict(name = "VBF125",filename = pathMC2022EE+"VBFH125/ZZ4lAnalysis.root"),
            dict(name = "WplusH125",filename = pathMC2022EE+"WplusH125/ZZ4lAnalysis.root"),
            dict(name = "WHminus125",filename = pathMC2022EE+"WHminus125/ZZ4lAnalysis.root"),
            dict(name = "ttH125",filename = pathMC2022EE+"ttH125/ZZ4lAnalysis.root"),

            dict(name = "ZZTo4l",filename = pathMC2022EE+"ZZTo4l/ZZ4lAnalysis.root"),

            dict(name = "WWZ",filename = pathMC2022EE+"WWZ/ZZ4lAnalysis.root"),
            dict(name = "ZZZ",filename = pathMC2022EE+"ZZZ/ZZ4lAnalysis.root"),
            dict(name = "TTWW",filename = pathMC2022EE+"TTWW/ZZ4lAnalysis.root"),
        ]

    elif '2022' in outFile:
        samples = [
            dict(name = "ggH125",filename = pathMC2022+"ggH125/ZZ4lAnalysis.root"),
            dict(name = "VBF125",filename = pathMC2022+"VBFH125/ZZ4lAnalysis.root"),
            dict(name = "WplusH125",filename = pathMC2022+"WplusH125/ZZ4lAnalysis.root"),
            dict(name = "WHminus125",filename = pathMC2022+"WHminus125/ZZ4lAnalysis.root"),
            dict(name = "ttH125",filename = pathMC2022+"ttH125/ZZ4lAnalysis.root"),
            dict(name = "bbH125",filename = pathMC2022+"bbH125/ZZ4lAnalysis.root"),

            dict(name = "ZZTo4l",filename = pathMC2022+"ZZTo4l/ZZ4lAnalysis.root"),

            dict(name = "WWZ",filename = pathMC2022+"WWZ/ZZ4lAnalysis.root"),
            dict(name = "WZZ",filename = pathMC2022+"WZZ/ZZ4lAnalysis.root"),
            dict(name = "ZZZ",filename = pathMC2022+"ZZZ/ZZ4lAnalysis.root"),
            dict(name = "TTWW",filename = pathMC2022+"TTWW/ZZ4lAnalysis.root"),
            dict(name = "TTZZ",filename = pathMC2022+"TTZZ/ZZ4lAnalysis.root"),
        ]
